    ...
    >
      ...
      <Container className="relative z-10">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          {/* Greeting */}
          <span className="hero-greeting inline-block px-4 py-2 mb-6 text-sm font-medium text-emerald-500 bg-emerald-500/10 rounded-full border border-emerald-500/20">
            {t("greeting")}
          </span>
          ...
          {/* Role */}
          <h2 className="hero-title-role text-2xl sm:text-3xl md:text-4xl font-semibold text-muted-foreground mb-6">
            {t("title")}
          </h2>
