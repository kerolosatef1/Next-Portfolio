      ...
      <div ref={containerRef}>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start mb-20">
          ...
          <div className="space-y-8">
            ...
            <div
              ref={imageRef}
              className="relative aspect-square max-w-md mx-auto lg:mx-0 rounded-3xl overflow-hidden"
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        <div className="check-icon p-2 rounded-xl bg-emerald-500/10 text-emerald-500 group-hover:bg-emerald-500 group-hover:text-white transition-colors flex-shrink-0">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {statItems.map((stat, index) => (
            ...
            >
              ...
              <div
                className="stat-number text-4xl md:text-5xl font-bold text-foreground mb-2"
